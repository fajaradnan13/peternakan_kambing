        ...
        <div class="card-body">
            <form action="{{ route('sales.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="kode_transaksi" value="{{ $kode_transaksi }}" readonly>
                </div>
                <div class="form-group">
                    <label for="tgl_penjualan">Tanggal Penjualan</label>
                    <input type="date" class="form-control @error('tgl_penjualan') is-invalid @enderror" id="tgl_penjualan" name="tgl_penjualan" value="{{ old('tgl_penjualan') }}" required>
                    @error('tgl_penjualan')
                ...
                <div class="form-group">
                    ...
                    <select class="form-control @error('kambing_id') is-invalid @enderror" id="kambing_id" name="kambing_id" required>
                        ...
                        @foreach($kambings as $kambing)
                            <option value="{{ $kambing->id }}" {{ old('kambing_id') == $kambing->id ? 'selected' : '' }}>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('pembeli') is-invalid @enderror" id="pembeli" name="pembeli" value="{{ old('pembeli') }}" required>
                    @error('pembeli')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
